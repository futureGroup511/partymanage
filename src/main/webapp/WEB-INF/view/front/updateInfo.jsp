...
<link rel="stylesheet" href="${rootPath}css/front/updatePartyMemberInfo.css">
 ...
 <!-- Tab panes -->
     <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="home">
           <div id="body-three">`
           		<form action="${rootPath}party/toFront/updateInfo?judge=1" method="post" >          			
       ...
       <div role="tabpanel" class="tab-pane" id="profile">
           <div id="body-three">
           		<form action="${rootPath}party/toFront/updateInfo?judge=2" method="post">
