<%@page import="cn.edu.hist.partymanage.entity.Inform"%>
	...
	<div class="container">
		...
		<input type="hidden" name="id" value="${inform.id }">
			<div class="row">
				<div class="col-sm-12">
					<label>作者：</label>
					<input type="text" class="form-control" value="${inform.autherName }" disabled="disabled">
				</div>
			</div>
				...
				<label>可看部门：</label>
					<div>
						<label class="checkbox-inline">
							<c:if test="${inform.allDepartment}">
							...
							<c:if test="${!inform.allDepartment}">
								...
								for(Department dep:deppartments){
									...
									if(inform.isDepartmentIn(dep.getId())){
								%>
										<label class="checkbox-inline">
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<input type="text" class="form-control" name="title" maxlength="255" value="${inform.title }">
				</div>
